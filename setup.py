...
setup(
    name='topology_lib_python',
    version=find_version('lib/topology_lib_python/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url='https://github.com/HPENetworking/topology_lib_python/tree/master/doc',
    keywords='topology_lib_python',
    ...
    entry_points={
        'topology_library_10': [
            'python = topology_lib_python.library'
        ]
    }
)
